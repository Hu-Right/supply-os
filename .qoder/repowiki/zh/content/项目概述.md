...
## 更新摘要
**所做更改**   
- 移除了对已删除的"国际采购供应链平台（单进程全栈）/概述.md"文件的引用
- 更新了项目架构描述以反映当前前端应用结构
- 重新组织了核心模块路径，从旧的locales目录迁移到core/i18n
- 更新了支付模块的路径引用，从payment目录迁移到core/payment
- 保持了现有的功能模块和组件结构不变
...
## 项目结构
仓库采用按领域与职责划分的目录组织方式：
- src 下包含应用入口、页面组件、业务模块（如 payment）、核心功能模块（core）与共享类型定义。
- core 目录包含认证、HTTP客户端、国际化、支付环境检测等核心基础设施。
...
B --> C["src/App.tsx"]
C --> D["src/core/i18n/LocaleContext.tsx"]
...
I --> M["src/core/payment/env-detector.ts"]
C --> N["src/data/*"]
C --> O["src/types/*"]
```
...
- [src/core/i18n/LocaleContext.tsx:1-120](file://src/core/i18n/LocaleContext.tsx#L1-L120)
...
- [src/core/payment/env-detector.ts:1-120](file://src/core/payment/env-detector.ts#L1-L120)
...
- [src/App.tsx:1-120](file://src/App.tsx#L1-L120)
- [src/core/i18n/LocaleContext.tsx:1-120](file://src/core/i18n/LocaleContext.tsx#L1-L120)
- [src/core/i18n/en.json:1-120](file://src/core/i18n/en.json#L1-L120)
- [src/core/i18n/zh.json:1-120](file://src/core/i18n/zh.json#L1-L120)
- [src/TrainingPage.tsx:1-120](file://src/TrainingPage.tsx#L1-L120)
- [src/TrainingRegisterModal.tsx:1-120](file://src/TrainingRegisterModal.tsx#L1-L120)
- [src/PaymentModal.tsx:1-120](file://src/PaymentModal.tsx#L1-L120)
- [src/payment/PaymentService.ts:1-120](file://src/payment/PaymentService.ts#L1-L120)
