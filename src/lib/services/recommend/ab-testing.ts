 ...
 *              FNV-1a 32 位稳定哈希 % 100：同一 userId 桶恒定（纯函数，跨请求/重启/进程一致）。
 ...
 */
export const recoVariant = (userId: number): "control" | "treatment" =>
  AB_TREATMENT_PCT > 0 && fnv1a32(String(userId)) % 100 < AB_TREATMENT_PCT ? "treatment" : "control";
