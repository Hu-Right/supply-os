...
export const KNOWN_ACRONYMS = new Map<string, PatternI18nResult>([
  ...
  // ── 肯尼亚常见机构（避免 KENYA_PREFIX_MAP 通用模式产生中英混合）──
  ["KENYA RAILWAYS", { canonical: "Kenya Railways", i18n: { zh: "肯尼亚铁路局", fr: "Kenya Railways", ru: "Железные дороги Кении", es: "Ferrocarriles de Kenia", ar: "سكك حديد كينيا" } }],
  ["KENYA REVENUE AUTHORITY", { canonical: "KRA", i18n: { zh: "肯尼亚税务局", fr: "Kenya Revenue Authority", ru: "Налоговое управление Кении", es: "Autoridad de Ingresos de Kenia", ar: "هيئة الإيرادات الكينية" } }],
  ["KENYA FOREST SERVICE", { canonical: "KFS", i18n: { zh: "肯尼亚林业局", fr: "Kenya Forest Service", ru: "Лесная служба Кении", es: "Servicio Forestal de Kenia", ar: "خدمة الغابات الكينية" } }],
  ["KENYA AIRPORT AUTHORITY", { canonical: "KAA", i18n: { zh: "肯尼亚机场管理局", fr: "Kenya Airport Authority", ru: "Управление аэропортов Кении", es: "Autoridad Aeroportuaria de Kenia", ar: "هيئة مطارات كينيا" } }],
  ["KENYA NATIONAL HIGHWAY AUTHORITY", { canonical: "KeNHA", i18n: { zh: "肯尼亚国家公路管理局", fr: "Kenya National Highway Authority", ru: "Национальное управление шоссейных дорог Кении", es: "Autoridad Nacional de Carreteras de Kenia", ar: "الهيئة الوطنية للطرق في كينيا" } }],
  ["KENYA URBAN ROADS AUTHORITY", { canonical: "KURA", i18n: { zh: "肯尼亚城市道路管理局", fr: "Kenya Urban Roads Authority", ru: "Управление городских дорог Кении", es: "Autoridad de Carreteras Urbanas de Kenia", ar: "هيئة الطرق الحضرية في كينيا" } }],
  ["KENYA RURAL ROADS AUTHORITY", { canonical: "KERRA", i18n: { zh: "肯尼亚乡村道路管理局", fr: "Kenya Rural Roads Authority", ru: "Управление сельских дорог Кении", es: "Autoridad de Carreteras Rurales de Kenia", ar: "هيئة الطرق الريفية في كينيا" } }],
  ["KENYA INVESTMENT AUTHORITY", { canonical: "KIA", i18n: { zh: "肯尼亚投资管理局", fr: "Kenya Investment Authority", ru: "Управление инвестиций Кении", es: "Autoridad de Inversiones de Kenia", ar: "هيئة الاستثمار الكينية" } }],
  ["KENYA REINSURANCE CORPORATION LTD", { canonical: "Kenya Re", i18n: { zh: "肯尼亚再保险公司", fr: "Kenya Reinsurance Corporation", ru: "Кения Перестрахование", es: "Corporación de Reaseguros de Kenia", ar: "مؤسسة كينيا لإعادة التأمين" } }],
  ["KENYA DEVELOPMENT CORPORATION", { canonical: "KDC", i18n: { zh: "肯尼亚发展公司", fr: "Kenya Development Corporation", ru: "Корпорация развития Кении", es: "Corporación de Desarrollo de Kenia", ar: "مؤسسة كينيا للتنمية" } }],
  ["KENYA MEDICAL SUPPLIES AUTHORITY", { canonical: "KEMSA", i18n: { zh: "肯尼亚医疗用品管理局", fr: "Kenya Medical Supplies Authority", ru: "Управление медицинских поставок Кении", es: "Autoridad de Suministros Médicos de Kenia", ar: "هيئة الإمدادات الطبية الكينية" } }],
  ["KENYA INDUSTRIAL RESEARCH & DEVELOPMENT INSTITUTE", { canonical: "KIRDI", i18n: { zh: "肯尼亚工业研究与开发研究所", fr: "Kenya Industrial Research & Development Institute", ru: "Кенийский институт промышленных исследований", es: "Instituto de Investigación Industrial de Kenia", ar: "معهد كينيا للبحوث الصناعية والتنمية" } }],
  ["KENYA INSTITUTE OF PRIMATE RESEARCH", { canonical: "KIPR", i18n: { zh: "肯尼亚灵长类研究所", fr: "Kenya Institute of Primate Research", ru: "Кенийский институт приматологии", es: "Instituto de Investigación de Primates de Kenia", ar: "معهد كينيا لأبحاث الرئيسيات" } }],
  ["KENYA INSTITUTE OF CURRICULUM DEVELOPMENT", { canonical: "KICD", i18n: { zh: "肯尼亚课程发展研究所", fr: "Kenya Institute of Curriculum Development", ru: "Институт развития учебных программ Кении", es: "Instituto de Desarrollo Curricular de Kenia", ar: "معهد كينيا لتطوير المناهج" } }],
  ["KENYA INDUSTRIAL TRAINING INSTITUTE", { canonical: "KITI", i18n: { zh: "肯尼亚工业培训研究所", fr: "Kenya Industrial Training Institute", ru: "Институт промышленной подготовки Кении", es: "Instituto de Formación Industrial de Kenia", ar: "معهد كينيا للتدريب الصناعي" } }],
