...
// ── 类型 ──
export type { PatternI18nResult } from "../../lib/data/agency-i18n/types";

// ── 纯数据 ──
export { KNOWN_ACRONYMS } from "../../lib/data/agency-i18n/known-acronyms";
export { COUNTRY_ZH, INTL_TYPE_EN } from "../../lib/data/agency-i18n/country-zh";

// ── RegExp 模式数据 ──
export {
  BR_PREFIX_MAP, BR_EXTRA_PREFIX_MAP, KENYA_PREFIX_MAP, INTL_PREFIX_MAP,
} from "../../lib/data/agency-i18n/prefix-patterns";
export { TYPE_PATTERNS, INTL_TYPE_PATTERNS } from "../../lib/data/agency-i18n/type-patterns";

// ── 逻辑函数 ──
export { translateByPattern } from "../../lib/data/agency-i18n/translate";
