...
export function NoticeSearchBar({
  ...
  return (
    ...
    >
      {/* 第一行：搜索 / 国家 / 排序 / 操作按钮 */}
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_160px_150px_auto] gap-3 lg:items-end">
      ...
      {/* 截止日期独立行：标签在上、输入框在下，垂直布局保证日期完整显示 */}
      <div className="grid grid-cols-2 lg:grid-cols-[1fr_1fr] gap-3">
