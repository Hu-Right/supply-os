        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="shrink-0 px-3 py-2 text-xs font-bold text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
