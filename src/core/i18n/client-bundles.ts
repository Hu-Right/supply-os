...
/** 客户端 i18next resources（与 SERVER_BUNDLES 形状一致） */
export const CLIENT_RESOURCES: Record<string, { translation: Record<string, string> }> = {
  ar: { translation: merge(arAuth, arCommon, arCrm, arLearning, arMembership, arPayment, arProcurement, arServices, arShowroom, arSupplier, arTraining) },
  en: { translation: merge(enAuth, enCommon, enCrm, enLearning, enMembership, enPayment, enProcurement, enServices, enShowroom, enSupplier, enTraining) },
  es: { translation: merge(esAuth, esCommon, esCrm, esLearning, esMembership, esPayment, esProcurement, esServices, esShowroom, esSupplier, esTraining) },
  fr: { translation: merge(frAuth, frCommon, frCrm, frLearning, frMembership, frPayment, frProcurement, frServices, frShowroom, frSupplier, frTraining) },
  ru: { translation: merge(ruAuth, ruCommon, ruCrm, ruLearning, ruMembership, ruPayment, ruProcurement, ruServices, ruShowroom, ruSupplier, ruTraining) },
  zh: { translation: merge(zhAuth, zhCommon, zhCrm, zhLearning, zhMembership, zhPayment, zhProcurement, zhServices, zhShowroom, zhSupplier, zhTraining) },
};
