...
export const CLIENT_RESOURCES: Record<string, { translation: Record<string, string> }> = {
  ar: { translation: merge(arAuth, arCommon, arCrm, arLearning, arMembership, arPayment, arProcurement, arServices, arSupplier, arTraining) },
  en: { translation: merge(enAuth, enCommon, enCrm, enLearning, enMembership, enPayment, enProcurement, enServices, enSupplier, enTraining) },
  es: { translation: merge(esAuth, esCommon, esCrm, esLearning, esMembership, esPayment, esProcurement, esServices, esSupplier, esTraining) },
  fr: { translation: merge(frAuth, frCommon, frCrm, frLearning, frMembership, frPayment, frProcurement, frServices, frSupplier, frTraining) },
  ru: { translation: merge(ruAuth, ruCommon, ruCrm, ruLearning, ruMembership, ruPayment, ruProcurement, ruServices, ruSupplier, ruTraining) },
  zh: { translation: merge(zhAuth, zhCommon, zhCrm, zhLearning, zhMembership, zhPayment, zhProcurement, zhServices, zhSupplier, zhTraining) },
};
