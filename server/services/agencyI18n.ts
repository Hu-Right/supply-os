...
const KNOWN_ACRONYMS = new Map<string, PatternI18nResult>([
...
const BR_EXTRA_PREFIX_MAP: Array<[RegExp, (rest: string) => PatternI18nResult]> = [
...
// ── 肯尼亚政府机构 ──
const KENYA_PREFIX_MAP: Array<[RegExp, (rest: string) => PatternI18nResult]> = [
...
// ── 国际机构 ──
const INTL_PREFIX_MAP: Array<[RegExp, (rest: string) => PatternI18nResult]> = [
  [/^UN[\s-]+(.+)/i, (rest) => ({
    canonical: `UN ${rest}`,
...
const TYPE_PATTERNS: Array<[RegExp, { typeKey: string; i18n: Record<string, string> }]> = [
