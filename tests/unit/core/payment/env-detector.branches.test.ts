...
import { mapPaymentError, detectPlatformEnv, isMobile, fetchPaymentConfigStatus, isProviderConfigured, getAvailableProviders, getPaymentTips } from "@/core/payment/env-detector";
