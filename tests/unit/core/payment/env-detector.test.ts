...
import { mapPaymentError, detectPlatformEnv, isMobile, isDesktop, fetchPaymentConfigStatus, isProviderConfigured, getAvailableProviders, getPaymentTips } from "@/core/payment/env-detector";
