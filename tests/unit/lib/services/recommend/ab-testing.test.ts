...
import { recoVariant, AB_TREATMENT_PCT } from "@/lib/services/recommend/ab-testing";
...
describe("RECO_AB_TREATMENT_PCT 放量（模块加载时求值）", () => {
  async function loadWithPct(value: string): Promise<typeof import("@/lib/services/recommend/ab-testing")> {
    vi.resetModules();
    vi.stubEnv("RECO_AB_TREATMENT_PCT", value);
    return import("@/lib/services/recommend/ab-testing");
  }
